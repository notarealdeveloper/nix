...

{
  dconf.settings = {
    "" = {
      custom-list = [
        "custom25" "custom22" "custom20" "custom18" "custom16"
        "custom14" "custom12" "custom10" "custom8" "custom6"
        "custom4" "custom1" "custom0" "custom2" "custom3"
        "custom5" "custom7" "custom9" "custom11" "custom13"
        "custom17" "custom19" "custom21" "custom23" "custom24"
        "custom26" "custom27" "custom28" "__dummy__"
      ];
    ...
    "media-keys" = {
      home = [ "XF86Explorer" ];
      restart-cinnamon = [ "<Control><Alt>Escape" ];
      video-rotation-lock = [];
    };
